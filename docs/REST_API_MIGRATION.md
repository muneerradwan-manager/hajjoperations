...
30. [التفقّد الميداني Check-in](#30-التفقد-الميداني-check-in-migration-0087)
...
## 30. التفقّد الميداني Check-in (migration 0087)
...
**نُفِّذ على قاعدة حيّة** (2026-08-04).
...
| RPC `check_in_here` / `module_presence` + جدول `node_check_ins` (0087)                     | §30                   |
