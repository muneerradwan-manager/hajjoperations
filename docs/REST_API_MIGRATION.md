...
**والخريطة كذلك محروسة بـ `map.view`** منذ 0100. استدعاء `season_map` يضيّق لكل
قارئ كما كان — عضوٌ يرى أماكن ملفاته — وهذا لم يُمسّ؛ المتغيّر أن الموسم مبسوطاً
كاملاً منظرُ غرفة عمليات، والعضو لا يحتاجه ليخدم في برجه.
